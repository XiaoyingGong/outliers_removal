...
def create_train_or_test_data(img_r_list, img_s_list, labeled_data_list, search_index, train_or_test="train", descriptor_categories=None):
    ...
    for img_index in search_index:
        ...
        pre_matches_1, pre_matches_2, des_1, des_2, partial_index_1, partial_index_2, _, _, _, _ =\
        ...
        # 产生描述子
        inlier_index = np.arange(len(pre_matches_1))
        descriptor_final = create_descriptor.create_descriptor_inlier_version(pre_matches_1, pre_matches_2, des_1, des_2, partial_index_1, partial_index_2, inlier_index, descriptor_categories=descriptor_categories)
